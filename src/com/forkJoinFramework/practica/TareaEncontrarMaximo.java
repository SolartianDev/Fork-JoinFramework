...
public class TareaEncontrarMaximo extends RecursiveTask<Integer> {  // (1) Define una clase llamada TareaEncontrarMaximo que extiende RecursiveTask.
    ...
    if (fin - inicio < umbral) {  // (8) Comprueba si el tamaño del sub-array es menor que el umbral.
        ...
        // (15) Calcula el punto medio del sub-array.
        TareaEncontrarMaximo a1 = new TareaEncontrarMaximo(miArray, inicio, mitad, umbral);
        // (16) Crea una nueva tarea para la primera mitad del sub-array.
        a1.fork();
        // (17) Bifurca (fork) la primera sub-tarea para ejecución paralela.
        TareaEncontrarMaximo a2 = new TareaEncontrarMaximo(miArray, mitad + 1, fin, umbral);
        // (18) Crea una nueva tarea para la segunda mitad del sub-array.
            
        // Combinar los resultados de las sub-tareas y encontrar el máximo global
        return Math.max(a2.compute(), a1.join());
        // (19) Combina los resultados de las sub-tareas y encuentra el máximo global.
    }
  }
}
