...
// (1) Define una clase llamada AccionArrayAleatorio que extiende RecursiveAction.
    private final int umbral;  
// (2) Declara una variable para el umbral que determinará cuándo generar números aleatorios directamente.
    private final int[] miArray;  
// (3) Declara un arreglo de enteros para almacenar los números aleatorios.
    private int inicio; 
// (4) Declara una variable para el índice de inicio del sub-array.
    private int fin; 
// (5) Declara una variable para el índice de fin del sub-array.
    ...
    protected void compute() {  // (7) Implementa el método compute(), que se ejecuta cuando se inicia una tarea RecursiveAction.
        ...
        if (fin - inicio < umbral) {  // (8) Comprueba si el tamaño del sub-array es menor que el umbral.
            ...
            // (12) Crea una nueva tarea para la primera mitad del sub-array.
            AccionArrayAleatorio r2 = new AccionArrayAleatorio(miArray, mitad + 1, fin, umbral);
            // (13) Crea una nueva tarea para la segunda mitad del sub-array.
            
            // Realizar la bifurcación (fork) y ejecución paralela de las sub-tareas
            invokeAll(r1, r2);
            // (14) Invoca (fork) y ejecuta paralelamente las sub-tareas creadas.
        }
    }
}
